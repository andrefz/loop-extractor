bench_pack="ASCI_Purple"
bench_name="smg2000"

source_files=( "HYPRE_pcg.c" "HYPRE_struct_grid.c" "HYPRE_struct_matrix.c" "HYPRE_struct_pcg.c"
...
COMPILE_FLAGS=" -I. -D_POSIX_SOURCE -DHYPRE_TIMING -DHYPRE_SEQUENTIAL"
LINK_FLAGS=" "
